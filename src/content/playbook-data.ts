...
export const frameworkCards: FrameworkCard[] = [
  ...
  },
  {
    ...
    description: "The people side — visible executive sponsorship, workflow integration that makes v0 part of how work gets done, champion networks, coalition building, celebrating wins, and addressing resistance. This is where adoption lives or dies, and exactly what this playbook systematizes.",
    icon: "🎯",
  },
];
